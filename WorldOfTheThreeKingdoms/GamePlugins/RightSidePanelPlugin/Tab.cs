...
namespace RightSidePanelPlugin
{
    ...
    public class Tab
    {
        ...
        private RightSidePanelPlugin.ListKind listKind;
        ...
        internal Tab(TabListInFrame tabList, RightSidePanelPlugin.ListKind listKind)
        //internal Tab(TabListInFrame tabList, TabListPlugin.ListKind listKind)
        {
