...
namespace PersonDetailPlugin
{
    ...
    public class PersonDetailPlugin : GameObject, IPersonDetail, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.personDetail.BackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.BackgroundMask1 = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.BackgroundMask2 = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            this.personDetail.PictureNull = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("PictureNull").Value);
...
////////////////////////////////////////////////////
            ...
            this.personDetail.BiographyButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.BiographyPressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            ...
            this.personDetail.InformationBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.InformationMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.InformationMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            node = nextSibling.ChildNodes.Item(32);
            this.personDetail.DetailBackgroundClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.DetailBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.DetailMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.DetailMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            ...
            this.personDetail.TreasureBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.TreasureMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.TreasureMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            node = nextSibling.ChildNodes.Item(34);
            this.personDetail.TitleBackgroundClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.TitleBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.TitleMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.TitleMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            node = nextSibling.ChildNodes.Item(35);
            this.personDetail.SkillBackgroundClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.SkillBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.SkillMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.SkillMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);           
            node = nextSibling.ChildNodes.Item(36);
            this.personDetail.StuntBackgroundClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.StuntBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.StuntMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.StuntMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            ...
            this.personDetail.BiographyBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.BiographyMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.BiographyMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            ...
            this.personDetail.SpecialtyShowBackgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.SpecialtyShowMask1Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask1").Value);
            this.personDetail.SpecialtyShowMask2Texture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\" + node.Attributes.GetNamedItem("Mask2").Value);
            ...
            this.personDetail.FactionNameBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Faction\" + node.Attributes.GetNamedItem("Background").Value);
            node = nextSibling.ChildNodes.Item(76);
            this.personDetail.FactionColourClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.FactionColour = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Faction\" + node.Attributes.GetNamedItem("ColourPicture").Value);
            this.personDetail.FactionColourBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Faction\" + node.Attributes.GetNamedItem("ColourBackground").Value);
            //
            ...
            this.personDetail.ImportantTreasureButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.ImportantTreasurePressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            //
            ...
            this.personDetail.ImportantTreasureBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.ImportantTreasureMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Mask").Value);
            this.personDetail.ImportantTreasureShowMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("TreasureMask").Value);
            ...
            this.personDetail.GeneralTreasureBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.GeneralTreasureMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.ImportantTreasureTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.ImportantTreasureTextMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.TheSexPicture1 = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Sex\" + node.Attributes.GetNamedItem("SexPicture1").Value);
            this.personDetail.TheSexPicture2 = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Sex\" + node.Attributes.GetNamedItem("SexPicture2").Value);
            //
            ...
            this.personDetail.GeneralTreasureShowBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.GeneralTreasureShowMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTreasure\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.ImportantTitleTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle1Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle2Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle3Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle4Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle5Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle6Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle7Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle8Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle9Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle10Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle11Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle12Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle13Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle14Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle15Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle16Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle17Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle18Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle19Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle20Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantTitle1Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle2Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle3Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle4Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle5Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle6Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle7Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle8Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle9Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle10Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle11Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle12Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle13Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle14Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle15Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle16Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle17Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle18Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle19Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantTitle20Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantTitle\" + node.Attributes.GetNamedItem("FileName").Value);
            //
            ...
            this.personDetail.ImportantStuntTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt1Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt2Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt3Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt4Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt5Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt6Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt7Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt8Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt9Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt10Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt11Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt12Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt13Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt14Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt15Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt16Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt17Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt18Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt19Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt20Background = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("Background").Value);
            ...
            this.personDetail.ImportantStunt1Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt2Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt3Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt4Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt5Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt6Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt7Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt8Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt9Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt10Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt11Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt12Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt13Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt14Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt15Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt16Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt17Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt18Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt19Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ImportantStunt20Picture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\ImportantStunt\" + node.Attributes.GetNamedItem("FileName").Value);
            //
            ...
            this.personDetail.BiographyBriefButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.BiographyBriefPressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            ...
            this.personDetail.BiographyRomanceButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.BiographyRomancePressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            ...
            this.personDetail.BiographyHistoryButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.BiographyHistoryPressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            ...
            this.personDetail.BiographyInGameButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.BiographyInGamePressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            ...
            this.personDetail.RelativeButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.RelativePressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            node = nextSibling.ChildNodes.Item(262);
            this.personDetail.RelationButtonClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.RelationButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.RelationPressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            ...
            this.personDetail.PersonRelationButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.PersonRelationPressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            node = nextSibling.ChildNodes.Item(264);
            this.personDetail.StandingsButtonClient = StaticMethods.LoadRectangleFromXMLNode(node);
            this.personDetail.StandingsButtonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName0").Value);
            this.personDetail.StandingsPressedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\Button\" + node.Attributes.GetNamedItem("FileName1").Value);
            //
            ...
            this.personDetail.RelativeBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.RelativeMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.RelationBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.RelationMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.PersonRelationBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.PersonRelationMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.StandingsBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Background").Value);
            this.personDetail.StandingsMask = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("Mask").Value);
            ...
            this.personDetail.PersonSkillTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("PersonSkill").Value);
            this.personDetail.LearnableSkillTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("LearnableSkill").Value);
            this.personDetail.AllSkillTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("AllSkill").Value);      
            ...
            this.personDetail.TitleTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.StuntTextBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.ConditionBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.personDetail.InfluenceBackground = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\PersonDetail\Data\Backgrounds\DetailBackgrounds\" + node.Attributes.GetNamedItem("FileName").Value);
            //
