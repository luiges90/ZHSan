...
namespace TroopArrangementPlugin
{

    public class TabListPlugin : GameObject, IBianduiLiebiao, IBasePlugin, IPluginXML, IPluginGraphics
    {
        private string author = "clip_on";
        private const string DataPath = @"Content\Textures\GameComponents\TroopArrangement\Data\";
        private string description = "可选择类别的详细列表";
        private const string Path = @"Content\Textures\GameComponents\TroopArrangement\";
        private string pluginName = "TroopArrangementPlugin";
        private TabListInFrame tabList = new TabListInFrame();
        private string version = "1.0.1";
        private const string XMLFilename = "TroopArrangementPlugin.xml";
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.tabList.leftedgeTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(1);
            this.tabList.rightedgeWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.rightedgeTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(2);
            this.tabList.topedgeWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.topedgeTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(3);
            this.tabList.bottomedgeWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.bottomedgeTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(4);
            this.tabList.backgroundTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.ToolTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.ToolSelectedTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("Selected").Value);
            ...
            this.tabList.tabbuttonTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.tabbuttonselectedTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("SelectedFileName").Value);
            node = nextSibling.ChildNodes.Item(7);
            this.tabList.columnheaderHeight = int.Parse(node.Attributes.GetNamedItem("Height").Value);
            this.tabList.columnheaderTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.columnspliterTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(9);
            this.tabList.scrollbuttonWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.scrollbuttonTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(10);
            this.tabList.scrolltrackWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.scrolltrackTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(11);
            this.tabList.leftArrowTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("LeftFileName").Value);
            this.tabList.rightArrowTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("RightFileName").Value);
            node = nextSibling.ChildNodes.Item(12);
            this.tabList.focusTrackTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.checkboxTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.checkboxSelectedTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("SelectedFileName").Value);
            this.tabList.roundcheckboxTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("RoundFileName").Value);
            this.tabList.roundcheckboxSelectedTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("RoundSelectedFileName").Value);
            ...
            this.tabList.TopLeftTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(20);
            //this.gameFrame.TopRightWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.TopRightTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(21);
            //this.gameFrame.BottomLeftWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.BottomLeftTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(22);
            //this.gameFrame.BottomRightWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.BottomRightTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\TroopArrangement\Data\" + node.Attributes.GetNamedItem("FileName").Value);
        ...
        {
            this.LoadDataFromXMLDocument(@"Content\Data\Plugins\TroopArrangementPlugin.xml");
        }
