...
namespace GameRecordPlugin
{
    ...
    public class GameRecordPlugin : GameObject, IGameRecord, IBasePlugin, IPluginXML, IPluginGraphics, IScreenDisableRects
    {
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.gameRecord.ToolTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\GameRecord\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.gameRecord.ToolSelectedTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\GameRecord\Data\" + node.Attributes.GetNamedItem("Selected").Value);
            ...
            this.gameRecord.RecordBackgroundTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\GameRecord\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.gameRecord.Record.Builder = font;  //.SetFreeTextBuilder(font);
            ...
            this.gameRecord.Tool1Texture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\GameRecord\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.gameRecord.Tool1SelectedTexture = CacheManager.GetTempTexture(@"Content\Textures\GameComponents\GameRecord\Data\" + node.Attributes.GetNamedItem("Selected").Value);
        ...
        {
            this.gameRecord.Initialize(screen);
        }
