...
namespace BianduiLiebiaoChajian
{
    ...
    public class TabListPlugin : GameObject, IBianduiLiebiao, IBasePlugin, IPluginXML, IPluginGraphics
    {
        ...
        private const string DataPath = @"Content\Textures\GameComponents\BianduiLiebiao\Data\";
        private string description = "可选择类别的详细列表";
        private const string Path = @"Content\Textures\GameComponents\BianduiLiebiao\";
        ...
        public void LoadDataFromXMLDocument(string filename)
        {
            ...
            this.tabList.leftedgeTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(1);
            this.tabList.rightedgeWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.rightedgeTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(2);
            this.tabList.topedgeWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.topedgeTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(3);
            this.tabList.bottomedgeWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.bottomedgeTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(4);
            this.tabList.backgroundTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.ToolTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.ToolSelectedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("Selected").Value);
            ...
            this.tabList.tabbuttonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.tabbuttonselectedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("SelectedFileName").Value);
            node = nextSibling.ChildNodes.Item(7);
            this.tabList.columnheaderHeight = int.Parse(node.Attributes.GetNamedItem("Height").Value);
            this.tabList.columnheaderTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.columnspliterTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(9);
            this.tabList.scrollbuttonWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.scrollbuttonTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(10);
            this.tabList.scrolltrackWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.scrolltrackTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(11);
            this.tabList.leftArrowTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("LeftFileName").Value);
            this.tabList.rightArrowTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("RightFileName").Value);
            node = nextSibling.ChildNodes.Item(12);
            this.tabList.focusTrackTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            ...
            this.tabList.checkboxTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            this.tabList.checkboxSelectedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("SelectedFileName").Value);
            this.tabList.roundcheckboxTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("RoundFileName").Value);
            this.tabList.roundcheckboxSelectedTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("RoundSelectedFileName").Value);
            ...
            this.tabList.TopLeftTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(20);
            //this.gameFrame.TopRightWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.TopRightTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(21);
            //this.gameFrame.BottomLeftWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.BottomLeftTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
            node = nextSibling.ChildNodes.Item(22);
            //this.gameFrame.BottomRightWidth = int.Parse(node.Attributes.GetNamedItem("Width").Value);
            this.tabList.BottomRightTexture = CacheManager.LoadTempTexture(@"Content\Textures\GameComponents\BianduiLiebiao\Data\" + node.Attributes.GetNamedItem("FileName").Value);
