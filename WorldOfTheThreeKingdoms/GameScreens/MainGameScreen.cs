...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        private void ResetTiles()
        {
            if (Session.Current.Scenario.ScenarioMap != null)
            {
                ...
                {
                    this.mainMapLayer.TileWidth = (this.viewportSize.X / Session.Current.Scenario.ScenarioMap.MapDimensions.X) + (Session.Current.Scenario.Parameters.ZoomMin / 5);
                }
                if (this.mainMapLayer.TotalTileHeight < this.viewportSize.Y)
                {
                    this.mainMapLayer.TileWidth = (this.viewportSize.Y / Session.Current.Scenario.ScenarioMap.MapDimensions.Y) + (Session.Current.Scenario.Parameters.ZoomMin / 5);
                }
            }
        }
