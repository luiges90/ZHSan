    ...
    class EventTab : BaseTab<Event>
    {
        ...
        protected override Dictionary<String, String> GetHelpText()
        {
            return new Dictionary<string, string>()
            {
                ...
                { "EventDialogString","对话。先指定第k个武将，后跟随一段对话。以空格分隔。可使用%k表示第k个武将的姓名。" },
                ...
                { "Image","图片。图片档案放在Content/Textures/GameComponents/EventDisplay/Data/tupian里" },
                { "Sound","音效。音效档案放在Content/Textures/GameComponents/EventDisplay/Data/yinxiao里" },
