...
{
    class TroopTypeTab : BaseTab<MilitaryKind>
    {
        ...
        protected override Dictionary<String, String> GetHelpText()
        {
            return new Dictionary<string, string>()
            {
                ...
                { "Description", "描述" },
                { "Merit", "强度（AI）" },
                { "Successor", "较强兵种ID：如果AI准备征召这个兵种的话，会考虑征召在这列表中的兵种，而这列表的兵种是绝对强于这个兵种" },
                { "Speed", "行动速率：行动速率高的部队将优先行动。行动速率＝兵种本身的行动速率×士气÷士气上限" },
                { "ObtainProb", "获得机率：每天有1/此数的机率，拥有武将的势力可获得这个兵种" },
        ...
        public TroopTypeTab(GameScenario scen, DataGrid dg, TextBlock helpTextBlock)
        {
